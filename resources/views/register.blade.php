...
<head>
  ...
  <link rel="stylesheet" href="multimedia/assets/css/login.css">
</head>
<body>
    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="multimedia/assets/img/login.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <img src="multimedia/assets/img/logo.svg" alt="logo" class="logo">
              </div>
              <p class="login-card-description">Make your account</p>
              <form action="#!">
              <div class="form-group">
                    <label for="email" class="sr-only">Nama</label>
                    <input type="name" name="nama" id="nama" class="form-control" placeholder="Name">
                  </div>
                  <div class="form-group">
